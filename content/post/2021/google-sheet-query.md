---
title: '在Google Sheet上使用query、if、isna将符合条件的分表数据汇总到总表'
date: 2019-08-18 12:35:27
tags: [query,google sheet]
published: true
hideInList: false
feature: https://i.loli.net/2021/02/26/rSnKQxLmvdpt8Wo.jpg
isTop: false
---
